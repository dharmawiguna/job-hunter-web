...
const Footer: FC<FooterProps> = ({}) => {
  return (
    <div className="bg-slate-900 px-32 pt-16 pb-11">
      <div className="flex flex-row items-start justify-between">
        <div>
          ...
          <div className="text-muted mt-8">
            Greate platform for the job seeker that <br />
        ...
        <div>
          ...
          <div className="text-muted">
            The latest job news, articles, sent to <br /> your inboc weekly
          </div>
      ...
      <Separator className="mt-20 mb-11 bg-gray-100" />
      <div className="flex flex-row items-center justify-between">
        <div className="text-slate-600">2024 @ Dhrm. All right reserved</div>
